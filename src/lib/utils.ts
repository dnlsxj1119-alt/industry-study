...
export function getMemberColorClasses(member: string): string {
  switch (member) {
    ...
    case '예준': return 'bg-rose-100 text-rose-700 border-rose-200';
...
export function getMemberBorderClass(member: string): string {
  switch (member) {
    ...
    case '예준': return 'border-rose-200 hover:border-rose-300';
